...
def main() -> None:
    ...
    for idx, lesson in enumerate(LESSONS):
        ...
        mid = build_backing_midi(lesson.template, lead_events, rng_seed=hash(lesson.id) & 0xFFFFFFFF)
        ...
        manifest_lessons.append({
            "id":         lesson.id,
            "title":      lesson.title,
            "video":      {"type": "file", "src": f"videos/{lesson.id}.webm"},
            "exercise":   {"sloppak": sloppak_name, "arrangement": ""},
